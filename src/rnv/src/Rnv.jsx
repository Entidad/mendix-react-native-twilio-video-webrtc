...
export class Rnv extends Component {
    state = {
        ...
        videoTracks: new Map(),
        roomName: "",
        token: "qwer" //this.props.accesstoken,//'',
    };
    componentDidMount() {
        // on start we are asking the permisions
        //alert("MOUNTED");//GetAllPermissions();
        GetAllPermissions();
        alert("appVersion:", VersionNumber.appVersion);
        //alert(JSON.stringify(this.props))
    }
    _onConnectButtonPress = () => {
        alert("in on connect button preess");
    ...
    render() {
		...
		return (
		    <View style={{}}>
			<Text style={{color: "#000000"}}>{JSON.stringify(this.props)}</Text>
		    </View>
		)
		*/
        return (
                        ...
                        {this.state.status === "connected" && (
                            <View style={styles.remoteGrid}>
                                <TouchableOpacity
                                    ...
                                    onPress={() => {
                                        this.setState({ isButtonDisplay: !this.state.isButtonDisplay });
                                    }}
                                >
